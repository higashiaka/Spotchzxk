      ...
      >
        {categories.map(({ key, label }) => (
          <button
            ...
            className="h-11 md:h-14 rounded-lg text-sm md:text-base font-black transition-colors"
            style={{
          ...
          rankings.map(entry => (
            ...
            >
              ...
              <div className="flex items-center gap-2 md:gap-4 flex-1 min-w-0">
                <div
                  className="w-8 h-8 md:w-12 md:h-12 rounded-full flex items-center justify-center shrink-0 text-white text-xs md:text-base font-black"
